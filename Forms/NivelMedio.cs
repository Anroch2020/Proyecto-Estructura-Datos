...
namespace Proyecto
{
    public partial class NivelMedio : Form
    {
        ...
        private const int TiempoLimiteMinutos = 3;
        ...
        private static readonly Color ColorBoton = Color.SandyBrown;
        private static readonly Color ColorBotonHover = Color.DarkSalmon;
        private static readonly Color ColorBotonPress = Color.Sienna;
        ...
        /// <summary>
        /// Constructor del formulario de nivel medio
        /// </summary>
        public NivelMedio()
        {
            InitializeComponent();
        ...
        private void AgregarControlMusica()
        {
            Button btnMusica = new Button
            {
                ...
                BackColor = Color.FromArgb(255, 165, 79), // Naranja más suave para este nivel
